...
def main():
    ...
    if installer_ok(installer_data, expected_sha256):
        print("Integrity verifyed.")

        # Save the downloaded VLC installer to disk
        installer_path = save_installer(installer_data)
        print("Saved:", installer_path)
...
def installer_ok(installer_data, expected_sha256):
    ...
    if resp_msg.status_code == requests.codes.ok:
        installer_data = resp_msg.content
    Computing_sha256 = hashlib.sha256(installer_data).hexdigest()
    return Computing_sha256 
...
def run_installer(installer_path):
    ...
    installer_path = r"C:\Users\darsh\Downloads\vlc-3.0.17.4-win64.exe"
